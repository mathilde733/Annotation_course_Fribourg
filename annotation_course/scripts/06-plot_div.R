packages <- c("reshape2", "tidyverse", "data.table")
...
data <- "/data/users/mjacquey/annotation_course/results/EDTA_annotation/ERR11437317.asm.bp.p_ctg.fa.mod.EDTA.anno/ERR11437317.asm.bp.p_ctg.fa.mod.out.landscape.Div.Rname.tab"
