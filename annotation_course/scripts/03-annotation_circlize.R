...
gff_file <- "/data/users/mjacquey/annotation_course/results/EDTA_annotation/ERR11437317.asm.bp.p_ctg.fa.mod.EDTA.anno/ERR11437317.asm.bp.p_ctg.fa.mod.EDTA.TEanno.gff3"
...
custom_ideogram <- read.table("/data/users/mjacquey/annotation_course/data/ERR11437317.asm.bp.p_ctg.fa.fai", header = FALSE, stringsAsFactors = FALSE)
